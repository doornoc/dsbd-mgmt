...
APP_NAME = 'doornoc_mgmt'
SITE_TITLE = os.environ.get('SITE_TITLE', 'doornoc management')
SITE_HEADER = os.environ.get('SITE_HEADER', 'doornoc management')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': ['mgmt.templatetags.extra'],
        },
    },
]
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get('DATABASE_NAME', 'dsbd_mgmt'),
        "USER": os.environ.get('DATABASE_USER', 'dsbd_mgmt'),
